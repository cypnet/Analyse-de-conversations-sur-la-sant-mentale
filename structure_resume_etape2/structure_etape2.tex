...
\begin{tikzpicture}[
  ...
  group/.style={draw=orange!75!black, rounded corners, dashed, inner sep=12pt, thick},
  subgroup/.style={group, draw=red!70!black, inner sep=8pt},
...
\end{tikzpicture}%
\label{fig:flowchart-etape2-legend}
\end{center}
\end{figure}
